...
CORRECT_COLOR2 = "#FC0FC0"       # Bright Pink for correct letters
PRESENT_COLOR2 = "#FFA500"       # Bright Orange for misplaced letters
MISSING_COLOR2 = "#999999"       # Gray for letters that don't appear
